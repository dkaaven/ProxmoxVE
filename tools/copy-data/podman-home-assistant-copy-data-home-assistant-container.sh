...
# run from the Proxmox Shell
<<<<<<< HEAD
# bash -c "$(curl -fsSL https://raw.githubusercontent.com/dkaaven/ProxmoxVE/mainmain/tools/copy-data//podman-home-assistant-copy-data-home-assistant-container.sh)"
=======
# bash -c "$(curl -fsSL https://raw.githubusercontent.com/dkaaven/ProxmoxVE/mainmain/tools/copy-data//podman-home-assistant-copy-data-home-assistant-container.sh)"
>>>>>>> 6e1d1e421 (fixing)
